...
import CreateGame from "../../pages/create-game/create-game.jsx"
        ...
        <Routes>
          ...
          {tokensPresent && (
            <>
              ...
              <Route path={Path.ProfileEdit} element={<ProfileEdit tokensPresent={tokensPresent} />} />
              ...
              <Route path={Path.CreateGame} element={<CreateGame tokensPresent={tokensPresent} />} />
            </>
          )}
